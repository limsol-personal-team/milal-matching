...
const CheckInPage: React.FC = () => {
  ...
  return (
    <div style={{ backgroundColor: '#e0f2f1', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      <header style={{ backgroundColor: '#80cbc4', padding: '1rem', color: 'white', textAlign: 'center' }}>
        <h1>My Form</h1>
      </header>
      {submissionStatus && (
        <div
      ...
      <div style={{ flex: 1, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
        <form
          style={{ backgroundColor: '#e0f2f1', padding: '1rem', color: '#37474f', width: '300px' }}
        ...
        >
          ...
          <div style={{ marginBottom: '1rem' }}>
            <label htmlFor="checked" style={{ fontSize: '30px' }}>Check:</label>
            <input type="checkbox" id="checked" {...register('checked')} style={{ transform: 'scale(1.5)' }} />
          </div>
